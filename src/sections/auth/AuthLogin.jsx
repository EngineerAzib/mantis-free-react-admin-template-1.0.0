...
export default function AuthLogin({ isDemo = false }) {
  ...
  return (
    <>
      <Formik
        initialValues={{
          email: isDemo ? 'info@codedthemes.com' : 'pc19694.azib@gmail.com',
          password: isDemo ? '123456' : 'Azib@2020',
          submit: null,
        }}
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          try {
            ...
            setErrors({ submit: typeof err === 'string' ? err : err.message || 'Login failed' });
            setStatus({ success: false });
            setSubmitting(false);
          }
        }}
